...
export const saveVideo = async (userID, videoID) => {
    try {
        //TODO Check if video is already saved if yes, show small message, video have been saved
        //TODO if no, then add to saveVideos
        // if on savedVideos remove from saved videos
